...
class CallHistory:
    ...
    def register_outgoing_call(self, call: Call) -> None:
        ...
        """
        # Get bill date from call
        date = call.get_bill_date()

        # If no outgoing call, add empty list to dict
        if date not in self.outgoing_calls:
            self.outgoing_calls[date] = []

        # Add call to list of outgoing calls
    ...
    def register_incoming_call(self, call: Call) -> None:
        ...
        # Add call to list of incoming calls
